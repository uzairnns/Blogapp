...
ActiveRecord::Schema.define(version: 20_220_726_113_411) do
  ...
  create_table 'likings', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['comment_id'], name: 'index_likings_on_comment_id'
    t.index %w[user_id comment_id], name: 'index_likings_on_user_id_and_comment_id', unique: true
